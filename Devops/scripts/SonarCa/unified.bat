...
dotnet sonarscanner begin /k:"Leo-Cs-RF_Host_Simulator" /d:sonar.host.url="%URL_PATH%"  /d:sonar.login="6a0db2874e06f33d82fca8cc5e4d5124d99c3d1c"
...
dotnet sonarscanner begin /k:"Leo-Cs-RF_MCU_Simulator" /d:sonar.host.url="%URL_PATH%"  /d:sonar.login="57f5d32d7b57cf8ae3690abcaa9fff596bda5d4e"
